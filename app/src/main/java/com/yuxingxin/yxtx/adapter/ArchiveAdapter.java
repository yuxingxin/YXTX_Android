...
public class ArchiveAdapter extends RecyclerView.Adapter<ArchiveAdapter.ArchiveViewHolder>{
    ...
    public ArchiveAdapter(Context context,List<ArticleTable> list){
    ...
    static class ArchiveViewHolder extends RecyclerView.ViewHolder implements View.OnClickListener{
        ...
        public ArchiveViewHolder(View itemView,MyItemClickListener listener) {
            super(itemView);
    ...
    public ArchiveViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        View v = LayoutInflater.from(context).inflate(R.layout.layout_archive_adapter,parent,false);
        return new ArchiveViewHolder(v,mItemClickListener);
    }
