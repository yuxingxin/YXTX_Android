package com.yuxingxin.yxtx.view;
...
import com.yuxingxin.yxtx.BuildConfig;
...
public class GroupListView extends ListView{
    ...
    public static interface GroupListAdapter extends ListAdapter {
    ...
    void createPinnedShadow(int position) {
        ...
        View pinnedView = getAdapter().getView(position, pinnedShadow.view, GroupListView.this);
    ...
    public void setAdapter(ListAdapter adapter) {
        ...
        if (BuildConfig.DEBUG && adapter != null) {
            if (!(adapter instanceof GroupListAdapter))
                throw new IllegalArgumentException("Does your adapter implement GroupListAdapter?");
    ...
    public static boolean isItemViewTypePinned(ListAdapter adapter, int viewType) {
        ...
        return ((GroupListAdapter) adapter).isItemViewTypePinned(viewType);
    }
}
